...
<link href="/Inferlytics/Analytics/_/css/fontello.css" rel="stylesheet"
	media="screen">
...
<body>
	...
	<img class="inf-tescowines-prd-prodimg" id="inf-mb-prd-productImg"
		src="" />
	<div>
		...
		<div id="inf-bw-klwinessimilar-block">
			Similar Wines
			<div id="inf-bw-klwinessimilar-innerBlock"></div>
		</div>
	...
	<script type="text/javascript">
		...
		var widget = new Inferlytics.InferlyticsEventsWidget({
			...
			brandName : 'tescowines',
			productName : 'tescowines',
			productId : prodId
		});
		...
		$
				.ajax({
					...
					data : "productId="
							+ prodId
							+ "&entity=tescowines&subProduct=tescowines&type=similarWines",
					dataType : "json",
		...
		$.ajax({
			...
			data : "productId=" + prodId
					+ "&entity=tescowines&subProduct=tescowines&type=keyWords",
			dataType : "json",
			success : function(data) {
		...
		function onClickShowMore() {
			...
			$("#inf-bw-klwinessimilar-innerBlock").data('owlCarousel').reinit({
				items : 2,
				pagination : false,
				navigation : true
			});
			$("#inf-bw-klwinessimilar-innerBlock").data('owlCarousel').goTo(
					currentvalue - 10);
