(function (a, b) {
    ...
    a.fn.cssRunQueue = function () {
        ...
        if (e[0]) v.cssEngine(e[0][0], e[0][1]);
    ...
    a.css3D = function (e) {
        a("body").data("cssPerspective", isFinite(e) ? e : e ? 1e3 : 0).cssOriginal(a.cssMerge({}, {
            TransformStyle: e ? "preserve-3d" : "flat"
        }, b))
    };
    a.cssPropertySupporter = function (e) {
        a.each(c, function (t, n) {
            if (e[n]) a.each(b, function (t, r) {
                var i = n.substr(0, 1);
    ...
    a.fn.cssEngine = function (e, t) {
        ...
        var r = this;
        var r = this;
        if (typeof t.complete == "number") r.data("cssCallIndex", t.complete);
        var i = {
            linear: "linear",
            swing: "ease",
            easeIn: "ease-in",
        ...
        if (e.transform) a.each(b, function (t, i) {
            var u = i + (i ? "T" : "t") + "ransform";
            var a = r.cssOriginal(n(u));
            var f = e.transform;
            if (!a || a == "none") s[u] = "scale(1)";
        ...
        if (u != undefined) {
            ...
            var g = e;
            a.extend(m, e);
            if (m.display == "callbackHide") f = true;
            else if (m.display) s["display"] = m.display;
            r.cssOriginal(s)
        }
        setTimeout(function () {
            r.cssOriginal(m);
    ...
    a.fn.cssFadeTo = function (e, t, n, r) {
        ...
        if (a.cssAnimateSupport()) {
            i.each(function (e, n) {
                n = a(n);
                if (n.data("displayOriginal") != n.cssOriginal("display") && n.cssOriginal("display") != "none") n.data("displayOriginal", n.cssOriginal("display") ? n.cssOriginal("display") : "block");
                else n.data("displayOriginal", "block");
    ...
    a.fn.cssStop = function () {
        ...
        e.data("cssAnimations", false).each(function (n, r) {
            ...
            setTimeout(function () {
                var n = a(e[t]);
                n.cssOriginal(s).data({
                    runningCSS: {},
                    cssAnimations: {},
                    cssQueue: [],
                    cssRunning: false
                });
                if (typeof n.data("cssCallIndex") == "number") n.data("cssCall")[n.data("cssCallIndex")].call(n);
                n.data("cssCall", []);
                t++
            }, 0)
        });
    ...
    if (a.fn.cssOriginal != undefined) a.fn.css = a.fn.cssOriginal;
     ...
     */
        ...
        function touchSwipe(e, t) {
            function E(e) {
                if (q()) return;
                if (jQuery(e.target).closest(t.excludedElements, d).length > 0) return;
                e = e.originalEvent;
            ...
            function S(e) {
                e = e.originalEvent;
                if (v === PHASE_END || v === PHASE_CANCEL) return;
                var n, r = SUPPORTS_TOUCH ? e.touches[0] : e;
            ...
            var n = SUPPORTS_TOUCH || !t.fallbackToMouseEvents,
